<section class="mt-4">
    <h1 class="font-bold text-2xl text-gray-500 mb-2">Valoracion</h1> 
    @can('enrolled',$course)
        <article class="mb-4">
            @can('valued', $course)
                <textarea wire:model="comment"  rows="3" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ingrese una reseña del curso"></textarea>
                <br>
            ...
            @else
                <div class="flex items-center bg-blue-500 text-white text-sm font-bold px-4 py-3" role="alert">
                    ...
                    <p>Ud ya ha valorado este curso</p>
                </div>    
            @endcan
                ...
                <article class="flex mb-4 text-gray-800">
                    ...
                    <div class="card flex-1">
                        <div class="card-body bg-gray-100">
                            <p><b>{{ $review->user->name }}</b><i class="fas fa-star text-yellow-300 ml-3"></i>{{ $review->rating }}</p>
