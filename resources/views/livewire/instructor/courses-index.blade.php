<div class="container py-8 ">
    ...
    <x-table-responsive>
        <div class="px-6 py-4 flex">
            <input wire:model="search" wire:keydown="limpiar_page"  class="flex-1 border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none"  placeholder="Ingresar nombre de un curso...">
                              ...
                              <div class="flex items-center">
                                  <div class="flex-shrink-0 h-10 w-10">
                                      @isset($course->image)
                                       ...
                                       @else
                                       <img id="picture" class="rounded-full h-10 w-10 object-cover object-center" src="https://images.pexels.com/photos/4218864/pexels-photo-4218864.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="">
                                      @endisset 
                                  </div>
                                  <div class="ml-4">
