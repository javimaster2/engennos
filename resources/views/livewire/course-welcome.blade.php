{{-- <div class="max-w-7xl mx-auto" wire:init="loadPost">
...
{{-- <div class="max-w-7xl mx-auto" wire:init="loadPost">
    ...
    @if (count($coursess))
        ...
        <div class="absolute inset-y-0 left-0 z-10 flex items-center">
            <button id="js-prev" @click="swiper.slidePrev()" 
        ...
        <div class="absolute inset-y-0 right-0 z-10 flex items-center" id="js-next">
