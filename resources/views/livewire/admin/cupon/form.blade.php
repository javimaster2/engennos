    ...
    <x-slot name="content">
        ...
        <div class="mb-4">
            ...
            <label for="estado" class="block text-left" >
                ...
                <select name="estado" wire:model="estado" id="estado" class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
            ...
            <label for="tipo" class="block text-left" >
                ...
                <select name="tipo" wire:model="tipo" id="tipo" class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
            ...
            {{-- <div class="form-group">
             ...
             <label for="value" class="block text-left" >
                ...
                <select name="tipo" wire:model="value" id="value" class="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
