                    ...
                    <tbody>
                        ...
                        @foreach ($users as $user)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="py-4 px-6 text-sm font-medium text-center whitespace-nowrap">
                                    <a href="{{ route('admin.reporte.show',$user) }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-500 dark:hover:underline cursor-pointer" title="Editar registro"><i class="fas fa-edit"></i></a>
