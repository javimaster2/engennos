...
<!-- component -->
    ...
    <!-- component -->
<!-- component -->
{{-- <div class="w-full bg-gradient-to-bl from-blue-900 via-blue-400 to-blue-900 -mt-3 pb-20 -mb-36">
    <div class="max-w-5xl mx-auto px-6 sm:px-6 lg:px-8 pt-20 pb-40">
        
        <div class="bg-white w-full shadow rounded p-8 sm:p-12  -sm:p-12">
  ...
  <div
    class="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-2xl border-t-1">
    <div class="flex flex-col justify-between">
      <div>
        <h2 class="text-4xl lg:text-5xl font-bold leading-tight">¿Tienes dudas? Escríbenos!</h2>
        <div class="text-gray-700 mt-8">
          Dejanos un mensaje para saber lo que ocurre.
        </div>
      </div>
      ...
      <form action="{{ route('contact.send') }}" method="POST">
        @csrf
          <div>
            ...
            <input class="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg border border-gray-400 placeholder-gray-300 focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300"
              type="text" placeholder="Haner Cano" name="name">
          </div>
          @error('name')
          ...
          <div class="mt-8">
            ...
            <input placeholder="youremail@gmail.com" class="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg border border-gray-400 placeholder-gray-300 focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300"
          ...
          <div class="mt-8">
            ...
            <textarea placeholder="Your Message"
              class="w-full h-32 bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg border border-gray-400 placeholder-gray-300 focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300" name="message"></textarea>
          </div>
          @error('message')
            <p><strong>{{ $message }}</strong></p>
          @enderror
